...
HD_PWD='C:/Users/theox/Desktop/aapl1_urbana/aapl1_urbana.runs/mb_snes_clk_wiz_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_snes_clk_wiz_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_snes_clk_wiz_1_0.tcl
