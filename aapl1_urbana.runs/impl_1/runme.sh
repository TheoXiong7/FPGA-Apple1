...
HD_PWD='C:/Users/theox/Desktop/aapl1_urbana/aapl1_urbana.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log apple1_urbana.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source apple1_urbana.tcl -notrace
