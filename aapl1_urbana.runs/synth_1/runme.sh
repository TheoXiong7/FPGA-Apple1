...
HD_PWD='C:/Users/theox/Desktop/aapl1_urbana/aapl1_urbana.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log apple1_urbana.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source apple1_urbana.tcl
